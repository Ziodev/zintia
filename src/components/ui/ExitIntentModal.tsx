...
const EXIT_COPIES: Record<Language, { title: string; desc: string; button: string; close: string }> = {
  es: {
    ...
    desc: "🎁 Tienes [1] Pase VIP Gratis para ver Modelos Privadas por 5 minutos.",
    button: "Reclamar Pase VIP Gratis",
    close: "No, gracias. Continuar al sitio.",
  },
  en: {
    title: "Leaving so soon?",
    desc: "🎁 You have [1] Free VIP Pass to watch Private Models for 5 minutes.",
    button: "Claim Free VIP Pass",
    close: "No, thanks. Continue to site.",
  },
  fr: {
    title: "Vous partez déjà?",
    desc: "🎁 Vous avez [1] Pass VIP Gratuit pour regarder des Modèles Privés pendant 5 minutes.",
    button: "Réclamer le Pass VIP Gratuit",
    close: "Non, merci. Retour au site.",
  },
  ja: {
    title: "もうお帰りですか？",
    desc: "🎁 プライベートモデルを5分間視聴できる「無料VIPパス」を1枚プレゼント！",
    button: "無料VIPパスを受け取る",
    close: "いいえ、戻ります",
  },
  it: {
    title: "Te ne vai così presto?",
    desc: "🎁 Hai [1] Pass VIP gratuito per guardare modelle private per 5 minuti.",
    button: "Richiedi il pass VIP gratuito",
    close: "No, grazie. Continua al sito.",
  },
  pt: {
    title: "Já vai embora?",
    desc: "🎁 Você tem [1] Passe VIP Grátis para ver Modelos Privados por 5 minutos.",
    button: "Reclamar Passe VIP Grátis",
  ...
  return (
    <div className="fixed inset-0 bg-black/85 backdrop-blur-md z-[100] flex items-center justify-center p-4">
      ...
      <div className="bg-zinc-900/90 border border-rose-500/20 rounded-3xl p-6 max-w-sm w-full relative shadow-2xl flex flex-col items-center text-center animate-in fade-in zoom-in-95 duration-200">
        ...
        <button
          onClick={handleClaim}
          className="w-full bg-rose-500 hover:bg-rose-600 text-white font-bold py-3.5 rounded-2xl flex items-center justify-center gap-1.5 transition-all active:scale-95 shadow-lg shadow-rose-500/20 font-heading text-xs uppercase tracking-wider animate-glow cursor-pointer"
        >
